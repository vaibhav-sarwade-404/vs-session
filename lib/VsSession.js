        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, new VsMongoSession(options)];
                ...
                case 3:
                    ...
                    return [2 /*return*/, new VsMongooseSession(options)];
            }
        });
    });
}
var VsSession = function (options) {
    ...
    return function (req, resp, next) { return __awaiter(void 0, void 0, void 0, function () {
        var vsMongoSessionStore, encrichRequest, createSession, updateSession, destroySession, getSession, cookies, onlyCheckSession, signedSessionCookie, sessionCookie, session, _a, _b, domain, _c, maxAge, _d, httpOnly, _e, path, _f, secure, sameSite, session, signedSessionCookie, sessionCookie;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0: return [4 /*yield*/, getMongoDbHandlerPackage(options.mongoDbOperationHandlerPackage || "mongodb", options)];
                case 1:
                    ...
                    if (!(cookies || (cookies && onlyCheckSession))) return [3 /*break*/, 6];
                    signedSessionCookie = (0, cookie_1.getCookie)(cookies, cookieName) || "";
                    if (!signedSessionCookie) return [3 /*break*/, 5];
                    sessionCookie = (0, cookie_1.getCookie)(cookies, cookieName, {
                        secret: options.secret
                    }) || "";
                    if (!(sessionCookie && (0, cookie_1.verify)(signedSessionCookie, options.secret))) return [3 /*break*/, 5];
                ...
                case 6:
                    if (!!onlyCheckSession) return [3 /*break*/, 9];
                    ...
                    return [4 /*yield*/, createSession({
                            key: constants_1.DEFAULTS.sessionId,
